        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <p className="text-xl text-gray-600 mt-4">
              Comprehensive guides and articles to help you make smarter auction decisions
            </p>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {validPillars.length > 0 ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-600">Content coming soon. Check back later for comprehensive auction intelligence guides.</p>
              </div>
            )}
          </div>
        </section>
