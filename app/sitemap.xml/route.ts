...
${urls.map((url) => {
  ...
  return `  <url>
    ...
    const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://ai-auction-strategist.vercel.app';
    const corePages = [
      ...
      { loc: `${BASE_URL}/integrations`, lastmod: new Date(), changefreq: 'monthly' as const, priority: 0.8 },
